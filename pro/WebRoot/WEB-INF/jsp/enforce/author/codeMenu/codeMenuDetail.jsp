...
<body class="body1" style="overflow: auto;">
	...
	<tr>
		...
		<td><input id="pid" name="PID" required="true" class="mini-combobox" valueField="ID" textField="NAME" 
				url="${Path}common/getCodeMenu.do" allowInput="false" 
				showNullItem="true"/></td>
	</tr>
	<tr>
		<td class="name"><label><span style="color:red;">*</span>类型：</label></td>
		<td><input id="type" name="TYPE" required="true" class="mini-combobox" valueField="pk" textField="name" data="[{pk:'0',name:'功能'},{pk:'1',name:'菜单'}]" allowInput="false" 
				showNullItem="false"	value="0" /></td>
		...
		<td><input id="url_" name="URL_"   vtype="maxLength:500"   maxlength="100" width="350px"  class="mini-textbox"/></td>
			...
			$.ajax({
					...
					success: function(data) {
						mini.alert("保存成功！"+data.flag, "提示",function(){
							location.href ="<%=path%>/codeMenuController/openDetail.do?id="+data.id;
							});
