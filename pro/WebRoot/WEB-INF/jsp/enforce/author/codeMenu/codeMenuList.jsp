...
<body class="body1">
	<div class="global2">
		...
		名称：<input id="rName" class="mini-textbox" maxlength="20" style="width:90px" />
	...
	<div property="columns">
		...
		<div field="TYPE" headerAlign="center" width="65">代码属性(类型、代码)</div>
