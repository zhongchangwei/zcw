...
<body class="12"  style="overflow: auto;">
	<div class="mini-layout" style="width:100%;height:100%;">
		   ...
		   <%--  <%@include file="deptList.jsp" %> --%>
		    
		<!--      <div class="global2">
				<div class="datagridtitle">菜单管理</div>
				<div class="mini-toolbar">
				部门：<input id="rName" class="mini-textbox" maxlength="20" style="width:90px" />
...
<script type="text/javascript">
    ...
    //一来就加载默认的tabs
     ...
     var url = "";	
     if('${type}'=="user"){//点击用户菜单
     	url = "${Path}userController/list.do"
     }else if('${type}'=="dept"){//点击部门菜单
     	url = "${Path}deptController/list.do"
     }else if('${type}'=="codeMenu"){//点击部门菜单
     	url = "${Path}codeMenuController/list.do"
     }
    load(url);//默认加载所有数据
